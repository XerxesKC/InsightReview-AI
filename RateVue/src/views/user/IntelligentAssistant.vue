...
const currentUserName = computed(() => userInfoStore.userInfo.userName || userInfoStore.userInfo.nickname || '我')

const getRequestHeaders = () => ({
  'X-User-Id': String(userInfoStore.userInfo.userId || ''),
  'X-User-Type': String(userInfoStore.userInfo.userType || 'user')
})
...
const stopGeneration = () => {
  ...
  if (activeStreamState.value) {
    activeStreamState.value.stoppedByUser = true
...
const sendMessage = async () => {
  ...
  if (!userInfoStore.userInfo.userId) {
    ElMessage.warning('当前用户信息未加载完成，请重新登录后再试')
    return
  }
  ...
  const pendingUserMessageId = `pending-user-${requestSeed}`
  ...
  try {
    ...
    patchChatMessage(pendingUserMessageId, {
    ...
    await loadSessionRetrievalConfig(nextSessionId, { silent: true })
...
<template>
  <div class="assistant-page assistant-page--user">
...
.assistant-page--user {
  --assistant-bg: linear-gradient(180deg, #f5f9fd 0%, #ebf3fb 100%);
  --assistant-surface: rgba(255, 255, 255, 0.92);
  --assistant-border: rgba(236, 196, 157, 0.88);
  --assistant-muted: #8b6f57;
  --assistant-text: #5b371f;
  --assistant-accent: #e38a3c;
  --assistant-accent-soft: rgba(227, 138, 60, 0.1);
  --assistant-topbar-start: #cd6d27;
  --assistant-topbar-end: #f09645;
  --assistant-user-bubble: #fde9d8;
  background: transparent;
}

.assistant-page--user .assistant-shell {
  border-radius: 24px;
  box-shadow: none;
  background: transparent;
}

.assistant-page--user .assistant-sidebar {
  padding: 18px;
  background: linear-gradient(180deg, rgba(255, 250, 245, 0.98) 0%, rgba(255, 243, 230, 0.98) 100%);
  border-right: 1px solid var(--assistant-border);
}

.assistant-page--user .assistant-main {
  background: transparent;
  backdrop-filter: none;
}

.assistant-page--user .sidebar-header {
  margin-bottom: 18px;
  padding-bottom: 14px;
  border-bottom: 1px solid rgba(192, 213, 232, 0.52);
}

.assistant-page--user .assistant-sidebar .sidebar-kicker {
  color: #a77d58;
  letter-spacing: 0.16em;
}

.assistant-page--user .assistant-topbar {
  padding: 18px 24px;
  border-bottom: none;
  background: linear-gradient(135deg, var(--assistant-topbar-start) 0%, var(--assistant-topbar-end) 100%);
}

.assistant-page--user .topbar-kicker {
  color: rgba(235, 245, 255, 0.74);
}

.assistant-page--user .assistant-topbar h3 {
  color: #f9fcff;
  background: none;
  -webkit-text-fill-color: initial;
}

.assistant-page--user .topbar-subtitle,
.assistant-page--user .session-id-label,
.assistant-page--user .session-id-value {
  color: rgba(235, 245, 255, 0.78);
}

.assistant-page--user .toolbar-actions {
  gap: 8px;
}

.assistant-page--user .toolbar-actions :deep(.el-button),
.assistant-page--user .session-action-row :deep(.el-button) {
  border-radius: 12px;
}

.assistant-page--user .toolbar-actions :deep(.el-button--primary),
.assistant-page--user .composer-actions :deep(.el-button--primary) {
...
.assistant-page--user .toolbar-actions :deep(.el-button),
.assistant-page--user .composer-actions :deep(.el-button),
.assistant-page--user .quick-question-button,
.assistant-page--user .session-card,
.assistant-page--user .turn-card {
  box-shadow: none !important;
}

.assistant-page--user .session-card,
.assistant-page--user .turn-card,
.assistant-page--user .source-card,
.assistant-page--user .collapsible-panel {
  border-radius: 14px;
  border: 1px solid transparent;
  background: transparent;
  box-shadow: none;
...
.assistant-page--user .session-card:hover,
.assistant-page--user .turn-card:hover {
  background: rgba(220, 135, 68, 0.06);
}

.assistant-page--user .session-card.active,
.assistant-page--user .turn-card,
.assistant-page--user .source-card,
.assistant-page--user .collapsible-panel {
...
.assistant-page--user .chat-panel {
  align-items: stretch;
}

.assistant-page--user .message-list {
  width: 100%;
  padding: 28px 28px 0;
}

.assistant-page--user .message-row {
  margin-bottom: 24px;
}

.assistant-page--user .user-bubble {
  background: var(--assistant-user-bubble);
  border-top-right-radius: 6px;
}

.assistant-page--user .message-image-attachment,
.assistant-page--user .chat-image-chip,
.assistant-page--user .retrieval-config-group {
  background: rgba(255, 255, 255, 0.78);
  border-color: rgba(232, 205, 178, 0.76);
}
...
.assistant-page--user .quick-question-button {
  color: #e38a3c;
  border-color: rgba(227, 138, 60, 0.2);
  background: rgba(227, 138, 60, 0.08);
}

.assistant-page--user .quick-question-button:hover {
  background: #e38a3c;
  color: #ffffff;
  border-color: #e38a3c;
  box-shadow: none;
...
.assistant-page--user .empty-chat-state {
  padding: 64px 28px 40px;
}

.assistant-page--user .empty-chat-icon {
  color: var(--assistant-accent);
}

.assistant-page--user .composer-wrapper {
  width: 100%;
  padding: 0 24px 22px;
}

.assistant-page--user .composer-panel {
  border-radius: 22px;
  border: 1px solid rgba(232, 205, 178, 0.9);
  background: rgba(255, 255, 255, 0.94);
  box-shadow: none;
}

.assistant-page--user .composer-panel:focus-within {
  border-color: rgba(220, 135, 68, 0.54);
  box-shadow: none;
}

.assistant-page--user .composer-footer {
  border-top: none;
}

.assistant-page--user .composer-hints,
.assistant-page--user .session-preview,
.assistant-page--user .turn-query,
.assistant-page--user .source-content,
.assistant-page--user .message-meta,
.assistant-page--user .sidebar-empty-hint {
  color: var(--assistant-muted);
}

.assistant-page--user .rating-panel :deep(.el-button) {
  min-width: 44px;
  height: 36px;
  padding: 0 10px;
  font-size: 14px;
...
.assistant-page--user .rating-panel :deep(.el-button:first-child) {
  color: #e38a3c;
  border-color: rgba(227, 138, 60, 0.28);
  background: rgba(227, 138, 60, 0.1);
}

.assistant-page--user .rating-panel :deep(.el-button:last-child) {
  color: #b75e37;
  border-color: rgba(183, 94, 55, 0.26);
  background: rgba(183, 94, 55, 0.1);
}

.assistant-page--user .rating-panel :deep(.el-button.active) {
  color: #ffffff !important;
  border-color: transparent;
}

.assistant-page--user .rating-panel :deep(.el-button.active span) {
  color: #ffffff !important;
}

.assistant-page--user .rating-panel :deep(.el-button:first-child.active) {
  background: #e38a3c;
}

.assistant-page--user .rating-panel :deep(.el-button:last-child.active) {
  background: #b75e37;
}

.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain) {
  background: #e38a3c;
  border-color: #e38a3c;
  color: #ffffff !important;
  box-shadow: none;
...
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain span) {
  color: #ffffff !important;
}

.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:hover),
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:focus) {
  background: #d97c2e;
  border-color: #d97c2e;
  color: #ffffff !important;
  box-shadow: none;
...
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:hover span),
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:focus span),
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:active span) {
  color: #ffffff !important;
}

.assistant-page--user :deep(.el-button),
.assistant-page--user :deep(.el-button:hover),
.assistant-page--user :deep(.el-button:focus),
.assistant-page--user :deep(.el-button:active) {
  box-shadow: none !important;
}

.assistant-page--user .session-title {
  color: #d97706;
}
...
.assistant-page--user .quick-question-button:hover,
.assistant-page--user .quick-question-button:focus {
  color: #ffffff;
  border-color: #d97706;
  background: #d97706;
  box-shadow: none !important;
...
.assistant-page--user .rating-panel :deep(.el-button:first-child) {
  ...
  box-shadow: none !important;
  --el-button-text-color: #b45309 !important;
  --el-button-hover-text-color: #ffffff !important;
  --el-button-active-text-color: #ffffff !important;
}

.assistant-page--user .rating-panel :deep(.el-button:first-child:hover),
.assistant-page--user .rating-panel :deep(.el-button:first-child:focus),
.assistant-page--user .rating-panel :deep(.el-button:first-child.active) {
...
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:hover),
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:focus),
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain:active) {
...
.assistant-page--user .rating-panel :deep(.el-button:first-child span),
.assistant-page--user .config-popover-content :deep(.el-button--primary.is-plain span) {
